...
// "This" is the current instance of the Student object, Joe.

// 2. What is "this" when joe.scopeArrow() is invoked?
// "This" is the entire page, because the next-nearest scope is the global scope.

// 3. Explain why "this" is different when an arrow function is used.
// Using the old format for function expressions/declarations, the scope was limited to the space within the function's curly braces.  Arrow functions, on the other hand, change the way scope works. Arrow functions are scoped to the next-nearest scope (which is to say that they also play well with nested functions or may also be scoped globally, if that is the next-nearest scope. do not recognize “this” as the current instance of the object, so “this” refers to the global object. Therefore, you will want to avoid using an arrow function in a constructor or any method that needs to use “this” to behave properly.
