...
function displayPics(){
  ...
  // 'rando' is a variable that is declared within function displayPics(). It is a local variable, not a global. As such, it cannot be accessed outside of the scope of the function in which it was declared.
  console.log(viewed);
